function [dret,feasible] = isFeasible_stability(Ts,Td,dStart)
% look for a feasibility solution for a given Ts=Tsample(1+Delta),
% Td=selected Tmad, and starting selection for
% delta (dStart)

global Axx Axe Aex Aee
...
for d=dStart:1:100 
    ...
    %LMIs
    M_01 = buildM_stability(P1,P21,P31,Axx,Axe,Aex,Aee,d,0);
    M_Td1 = buildM_stability(P1,P21,P31,Axx,Axe,Aex,Aee,d,Td);
    M_Td0 = buildM_stability(P1,P20,P30,Axx,Axe,Aex,Aee,d,Td);
    M_Ts0 = buildM_stability(P1,P20,P30,Axx,Axe,Aex,Aee,d,Ts);
