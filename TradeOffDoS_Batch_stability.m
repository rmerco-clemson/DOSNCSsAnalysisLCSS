%% this script creates the tradeoff curves for internal stability
...
while (stop==0) 
    ...
    for j=1:length(TdVectFor) %looking for Tmad for each value of Delta
        ...
        %looking for value of delta2 and delta3 such that the problem is
        %feasible for the selected values of Delta and Tmad
        [dret,feasible] = isFeasible_stability(Ts,Td,1) 
...
%save mat file
filename = strcat('tradeoffCurvesDeltaTmad_stability.mat');
